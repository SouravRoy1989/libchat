...
// The props are updated to include the delete handler function
interface SideNavProps {
  setIsSidebarOpen: (isOpen: boolean) => void;
  onNewChat: () => void;
  conversations: Conversation[];
  onSelectConversation: (id: string) => void;
  onDeleteConversation: (id: string) => void; // Add the new prop
...
export default function SideNav({
  ...
  // This effect for the user menu remains the same
  useEffect(() => {
  ...
  // These handlers for the user menu also remain the same
  ...
  return (
    ...
    >
      {/* Top Section: New Chat and Close button */}
      ...
      {/* Middle Section: Conversation history list */}
      <ConversationHistory
        conversations={conversations}
        onSelectConversation={onSelectConversation}
        onDeleteConversation={onDeleteConversation} // Pass the handler down to the child
